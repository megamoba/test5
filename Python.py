---------------------------------------------------------------------
キーワード1
False None True assert and as break continue class def del except elif else exec finally from for global import if in is lambda nonlocal not or print pass return raise try while with yield 
